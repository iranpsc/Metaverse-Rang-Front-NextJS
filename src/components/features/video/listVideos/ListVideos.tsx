...
const VideoCard = memo(
  ({ item, params, theme, categorySlug, subCategorySlug, categoryName, subCategoryName }: VideoCardProps) => {
    ...
    return (
      <div className="w-full min-h-[240px] shadow-md hover:shadow-xl duration-300 hover:dark:shadow-dark rounded-[12px] overflow-hidden bg-white dark:bg-gray-1  flex flex-col justify-start gap-6 items-center">
        <Link href={videoUrl} className="group w-full h-[260px] overflow-hidden  cursor-pointer relative">
          ...
          <div className="w-full h-full  absolute z-0 top-0 flex justify-center items-center rounded-t-[10px]">
            <div className="w-fit hover:scale-105 duration-100 rounded-full bg-white/30 /35 flex items-center justify-center p-5">
        ...
        <div className="w-[95%] flex flex-row justify-start items-center gap-1 mt-[-10px] pe-16">
          <Link
            ...
            className="text-start text-matn-2  font-medium font-azarMehr text-[13px] 3xl:text-[16px]"
          >
            {categoryName}
          </Link>
        ...
        <p className="w-[95%] mt-[-20px] text-matn-2 dark:text-matn-2 text-[12px] 3xl:text-[16px] line-clamp-2 overflow-hidden">
        ...
        <div className="w-[95%] pb-2 flex flex-row justify-between items-center">
          <Link href={`https://metarang.com/${params.lang}/citizen/${item.creator.code}`} target="_blank">
            <div className="flex flex-row justify-start items-center gap-2">
              ...
              />
              <span className="text-primary dark:text-blue-500 cursor-pointer text-[14px] md:text-base whitespace-nowrap font-medium  uppercase">
                {item.creator.code}
              </span>
            </div>
          </Link>
          ...
          <div className="flex flex-row justify-start items-center gap-3 md:gap-5">
            <div className="flex items-center gap-[5px]">
              <span className="whitespace-nowrap font-azarMehr font-normal 3xl:text-[18px] text-matn-2 ">
