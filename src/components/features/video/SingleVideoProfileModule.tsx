    ...
    <div className="w-full pb-2 flex flex-row gap-2 items-center pt-10 bg-white dark:bg-dark-background ps-5 ">
      ...
      <div className="flex flex-col justify-between gap-1">
        ...
        <p className="text-xs md:text-base dark:text-white">
          ...
          {" : "}
          <span className="mb-[-2px] uppercase text-primary dark:text-blue-500"><Link onClickCapture={() => setLinkLoading(true)} href={`https://metarang.com/${params.lang}/citizen/${DataVideo.creator.code}`}> {checkData(DataVideo.creator.code)}</Link></span>
        </p>
