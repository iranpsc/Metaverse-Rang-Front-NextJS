...
export default function CheckIp() {
  ...
  return (
    <div className=" w-[70%] h-[60%] mt-6">
      <h1 className="text-center font-azarMehr font-extrabold text-[25px] text-[#18C08F]">
        {selectLanguageAuthModule(lang).checkTextTitle}
      </h1>
      <p className="mt-4 text-center font-azarMehr font-medium text-[14px] text-[#0000005C] dark:text-white">
        {selectLanguageAuthModule(lang).checkTextTime}
      </p>
      <p className="mt-8 text-center font-azarMehr font-bold text-[14px] text-[#000000A1] dark:text-[#969696]">
      ...
      <div>
        <input
          ...
          className="mt-5 w-full h-[50px] outline-none border-[1px] border-[#DADADA] px-2"
          value={email}
      ...
      <button
        className="relative mt-3 dark:bg-[#18C08F80] bg-[#D7FBF0] text-[#18C08F] border-[#18C08F] border-[1px] w-full h-[50px]  rounded-[5px] font-azarMehr font-normal"
