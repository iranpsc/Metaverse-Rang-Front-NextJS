...
const ListVideos = ({ DataVideos, params }: any) => {
  ...
  return (
    <div className="my-[20px] grid md:grid-cols-2 lg:grid-cols-2 sm:grid-cols-2 xl:grid-cols-3 gap-10 w-[95%] h-fit pt-16 xs:flex xs:justify-center xs:items-center">
      {DataVideos &&
        DataVideos.videos.map((item: any) => (
          ...
          >
            ...
            <p className="text-start text-black dark:text-white w-[95%] font-azarMehr truncate cursor-pointer font-bold mt-[8px] text-[18px] 3xl:text-[22px] ">
              {item.title}
            </p>
