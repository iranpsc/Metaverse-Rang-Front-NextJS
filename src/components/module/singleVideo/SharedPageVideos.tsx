...
export default function SharedPageVideos({
  ...
  const handleCopyClick = async () => {
    try {
      const textToCopy = `https://rgb.irpsc.com/${router.query.lang}/education/category/${DataVideo.category.slug}/${DataVideo.sub_category.slug}/${DataVideo.slug}`;
  ...
  const handleShare = (platform: any) => {
    const urlToShare = `https://rgb.irpsc.com/${router.query.lang}/education/category/${DataVideo.category.slug}/${DataVideo.sub_category.slug}/${DataVideo.slug}`;
    let shareUrl = "";
  ...
  return (
    <div className="absolute backdrop-blur-sm bg-blackTransparent/30 z-[60] top-0 w-full h-screen ">
