...
export default function SharedPageVideos({
  ...
  return (
    <div
      className="fixed backdrop-blur-sm bg-blackTransparent/30 z-[60] top-0 right-0 w-screen h-screen overflow-clip"
                ...
                <div className=" 3xl:mx-5 xl:mx-1 lg:mx-5 sm:mx-10 xs:mx-20  flex flex-row justify-center items-center xl:gap-8 lg:gap-4 md:gap-4 sm:gap-2 xs:gap-2 py-2 w-full">
                  {items.map((item: any) => (
                    ...
                    >
                      ...
                      "
                      />
                      <p className="font-azarMehr font-bold dark:text-white text-black xl:text-[16px] lg:text-[16px] md:text-[14px] sm:text-[14px] xs:text-[12px] mt-3 px-5">
                        {item.title}
                      </p>
                    </div>
                  ))}
