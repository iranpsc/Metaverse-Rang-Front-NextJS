...
console.log('prize----------1',prize);
    ...
    <DetailItem title={targetData(levelsTranslatePage,"satisfaction unit")} value={prize.data.satisfaction} />
    <DetailItem title={targetData(levelsTranslatePage,"receive yellow color")} value={prize.data.yellow} />
