...
export default async function Gift({params,levelsTranslatePage,langData}:any){
const gift = await getLevelTabs(params)
    ...
    <div className="w-full flex flex-col-reverse sm:flex-row flex-wrap">
         ...
         <div className="w-full sm:w-4/5 flex flex-wrap justify-between">
            ...
            <DetailItem  title={targetData(levelsTranslatePage,"gift png file")} value={''} />
            <DetailItem  title={targetData(levelsTranslatePage,"gift fbx file")} value={''} />
        </div>
