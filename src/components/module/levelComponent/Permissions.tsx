  ...
  return (
    <>
      <div className="w-full sm:w-4/5 flex flex-wrap justify-between">
        ...
        <DetailItem
          showCheck={true}
          title={targetData(levelsTranslatePage, "to join the alliance")}
        ...
        <DetailItem
          showCheck={true}
          title={targetData(levelsTranslatePage, "inspection permit")}
        ...
        <DetailItem
          showCheck={true}
          title={targetData(levelsTranslatePage, "gate establishment license")}
        ...
        <DetailItem
          showCheck={true}
          title={targetData(levelsTranslatePage, "attorney's license")}
        ...
        <DetailItem
          ...
          title={targetData(
            levelsTranslatePage,
            "ability to rent a satisfaction unit"
          )}
        ...
        <DetailItem
          ...
          title={targetData(
            levelsTranslatePage,
            "permission to enter the city council"
          )}
          value={permissions.data.city_counsile_entry}
        />
        <DetailItem
          showCheck={true}
          title={targetData(levelsTranslatePage, "ability to enter judgment")}
        ...
        <DetailItem
          ...
          title={targetData(
            levelsTranslatePage,
            "property establishment permit on the surface"
          )}
        ...
        <DetailItem
          ...
          title={targetData(
            levelsTranslatePage,
            "ability to record special level positions"
          )}
