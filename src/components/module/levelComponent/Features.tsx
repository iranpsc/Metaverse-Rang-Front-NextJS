...
>>>>>>> f8ae2468ffb15959dbcdebd2039c9b1d3fbb22ec
          <Income className="w-full h-full" />
        </div>
        <div className="w-full rounded-[20px] cursor-cell p-3 pb-[15px] pt-[95px] xl:pt-[120px] 2xl:pt-[130px] 3xl:pt-[150px] h-[195px]  flex flex-col  justify-center items-center dark:bg-[#080807] bg-white base-shadow-1 hover:border hover:border-blueLink hover:dark:border-dark-yellow">
