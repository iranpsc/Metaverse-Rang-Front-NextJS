...
export default function ProfileTopMobile() {
  ...
  return (
    <>
      <div className="dark:bg-dark-background transition-all md:mt-1 duration-300 max-sm:mt-1  ease-linear flex flex-col bg-white justify-center  items-center rounded-md">
        <section className="w-full   flex flex-nowrap justify-around px-4 md:px-1 max-lg:px-0 items-center">
          <div className="group  relative flex justify-center items-center">
            ...
            />
            <p className="  max-sm:absolute  max-sm:bottom-[-25px]  max-sm:start-1 z-50 rounded-sm bg-white dark:bg-dark-background  w-max p-1 max-sm:scale-0  text-xs  text-black dark:text-white group-hover:scale-100 break-all  inline-block xl:mx-1 lg:mx-1 md:mx-0 md:text-xs font-medium font-azarMehr xl:text-[15px] text-start">
              {profileData?.name}
            </p>
          </div>
          ...
          <Image
            ...
            height={100}
            alt="profile"
            className="inline-block rounded-full xl:w-9 xl:h-9 lg:w-9 lg:h-9 md:w-7 md:h-7 max-lg:w-12 max-lg:h-12 object-cover"
          />
          <hr className="xl:w-10 lg:w-10 md:w-4 inline-block mx-1  text-lightGray dark:text-dark-lightWhite" />
          <p className=" dark:text-white max-lg:text-xl md:text-[15px] lg:text-lg xl:text-[15px]  inline-block mx-1 font-bold font-azarMehr text-extraGray">
          ...
          <div className=" relative text-center flex items-center justify-center">
            <Shahrvand
              ...
              height={100}
              alt="profile"
              className="inline-block rounded-full xl:w-10 xl:h-10 lg:w-10 lg:h-10 md:w-7 max-lg:w-12 max-lg:h-12 "
            />
