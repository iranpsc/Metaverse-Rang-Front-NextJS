...
export default function ProfileAbout({ setShowModal }: any) {
  ...
  return (
    <section className=" flex flex-col justify-between  items-center h-fit">
      <div className="dark:bg-dark-background  transition-all duration-300 ease-linear bg-white px-1 rounded-md pb-3">
        <h1 className="dark:text-white font-azarMehr font-bold text-black mt-4 mx-2 xl:text-md lg:text-sm md:text-sm ">
          {targetData(selectedProfileData, "about me")}
        </h1>
        <p className=" font-azarMehr  xl:leading-[30px] lg:leading-[20px] md:leading-[15px] line-clamp-4 mx-1 text-justify font-medium xl:text-[12px] lg:text-[10px] md:text-[10px]  text-gray">
