  ...
  return (
    <>
      <div className="w-[95%] mx-auto h-fit mt-36 flex flex-col justify-center items-center ">
        ...
        <div className="mt-10 grid 2xl:grid-cols-5 xl:grid-cols-5 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 xs:grid-cols-1 sm:place-items-center xs:place-items-center  xs:gap-x-1 w-full gap-3">
          {categoriesData &&
