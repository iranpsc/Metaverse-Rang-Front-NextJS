...
export default function TopTrainersFirstPage({ params, mainData, users }: any) {
  return (
    <>
      ...
      <div className="w-full relative flex flex-col lg:flex-row pb-10 lg:px-7 gap-1 items-center">
