        ...
        <>
            ...
            <div className="bg-white shadow-lg dark:bg-dark-background rounded-2xl p-5 dark:text-white text-gray-100 flex flex-col gap-5 md:gap-9">
                ...
                <div className="flex justify-between items-start">
                    <span className="text-[#52545C] dark:text-[#DEDEE9] text-base 2xl:text-xl">
                        {item.percent}% {findByUniqueId(mainData, 1486)}
                    </span>
                    <h3 className="text-light-primary dark:text-dark-yellow font-bold text-xl md:text-2xl 2xl:text-[32px]">
                        {item.id}
                    </h3>
                </div>
                ...
                <div className="flex flex-col gap-2 bg-[#F8F8F8] dark:bg-black py-3 rounded-xl px-3 relative">
                    <div className="flex items-center justify-center lg:justify-between">
                        ...
                        <div className="text-[#52545C]  items-center gap-1 text-sm md:text-base hidden lg:flex">
                            <div>{price}</div>
                        </div>
                        ...
                        <div className="flex items-center gap-2 justify-between w-full lg:w-auto">
                            <div ref={dropdownRef}>
                                ...
                                {dropdownOpen && (
                                    <div className="absolute bg-white text-black dark:bg-black mt-2 w-full top-14 z-20 right-0 border border-gray-700 rounded-xl shadow-lg text-gray-200">
                                        <div className="p-3">
                                            <input
                ...
                <div className="text-[#52545C] text-center  items-center gap-1 text-base md:text-base  lg:hidden">
                    <div>{price}</div>
                </div>
                ...
                <div className="flex justify-center">
                    <button aria-label="BUY BUTTON"
                        ...
                        className="bg-transparent w-max px-10 2xl:px-14 border border-light-primary text-light-primary dark:border-dark-yellow dark:text-dark-yellow py-3 rounded-xl lg:text-lg transition">
