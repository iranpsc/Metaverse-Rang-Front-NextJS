...
const TopWritersArticles = ({ params, mainData }: any) => {
  const staticUsers = [
    // {
    //   id: 1,
  ...
  return (
    <>
      ...
      <div className="w-full relative flex flex-col lg:flex-row pb-10 lg:px-7 items-center">
        ...
        {/* <div style={{ minWidth: '250px' }} className="bg-[#fff] dark:bg-[#1A1A18] mt-10 rounded-[20px] max-w-[260px] h-[415px] mx-2 flex flex-col gap-3 items-center justify-center hover:scale-105 base-transition-1 shadow-lg cursor-pointer">
...
export default TopWritersArticles;
