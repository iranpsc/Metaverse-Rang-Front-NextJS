...
export default function ArticleContent({ content, tags = [] }: ArticleContentProps) {
  return (
    <div className="flex flex-col gap-6">
      <div
        className="prose max-w-none prose-p:leading-9 lg:text-xl prose-h1:text-2xl prose-h2:text-2xl prose-h3:text-2xl prose-h4:text-xl space-y-5 prose-p:text-[#484950] dark:prose-p:text-[#868B90] dark:prose-h1:text-white dark:prose-h2:text-white dark:prose-h3:text-white prose-a:text-blueLink dark:prose-a:text-dark-yellow"
