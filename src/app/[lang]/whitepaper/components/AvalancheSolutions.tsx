...
export default function AvalancheSolutions({ params, mainData }: AvalancheSolutionsProps) {
    return (
        <section
            className="
                relative
                ...
                <header className="border-b border-solid border-x-0 border-t-0 dark:border-[#434343] border-[#D9D9D9] ">
                    <div className='flex gap-10 mt-5 items-center  pb-10'>
                        ...
                        <div className="text-start max-w-3xl">
                            <TextScramble className=" dark:text-white text-xl xl:text-3xl 2xl:text-5xl 3xl:text-6xl 2xl:!leading-[80px]"
                ...
                <div className="mt-10 grid grid-cols-1 gap-10 lg:grid-cols-[320px_1fr]">
                    ...
                    <aside className="w-full ">
                        <p
                            ...
                            "
                        >
                            {findByUniqueId(mainData, 1706)}
                        </p>
                    </aside>

                    {/* RIGHT SIDE */}
                    <div className="grid grid-cols-1 xl:grid-cols-2 mb-20 lg:pb-0">
