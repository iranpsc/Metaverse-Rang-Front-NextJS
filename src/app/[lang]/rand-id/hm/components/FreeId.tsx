...
const citizenData = [
  {
    ...
    currencies: [
      { key: "IRR", label: findByUniqueId(mainData, 906), icon: `
          ...
          <path class="stroke-primary dark:stroke-dark-primary" d="M25.7331 10.5619V17.4286C25.7331 21.5353 23.3865 23.2952 19.8665 23.2952H8.14644C7.54644 23.2952 6.97311 23.242 6.43978 23.122C6.10645 23.0687 5.78646 22.9753 5.49312 22.8687C3.49312 22.122 2.27979 20.3886 2.27979 17.4286V10.5619C2.27979 6.45526 4.62644 4.69531 8.14644 4.69531H19.8665C22.8531 4.69531 24.9998 5.96197 25.5731 8.85531C25.6665 9.38864 25.7331 9.93526 25.7331 10.5619Z" stroke="#9100D9" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
          <path class="stroke-primary dark:stroke-dark-primary" d="M29.7347 14.566V21.4327C29.7347 25.5394 27.3881 27.2993 23.8681 27.2993H12.1481C11.1614 27.2993 10.2681 27.1661 9.49475 26.8727C7.90808 26.2861 6.82807 25.0727 6.44141 23.1261C6.97474 23.2461 7.54807 23.2993 8.14807 23.2993H19.8681C23.3881 23.2993 25.7347 21.5394 25.7347 17.4327V10.566C25.7347 9.93933 25.6814 9.37937 25.5747 8.85938C28.1081 9.39271 29.7347 11.1793 29.7347 14.566Z" stroke="#9100D9" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
          <path class="stroke-primary dark:stroke-dark-primary" d="M13.9976 17.5244C15.9416 17.5244 17.5176 15.9484 17.5176 14.0044C17.5176 12.0604 15.9416 10.4844 13.9976 10.4844C12.0535 10.4844 10.4775 12.0604 10.4775 14.0044C10.4775 15.9484 12.0535 17.5244 13.9976 17.5244Z" stroke="#9100D9" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
          <path class="stroke-primary dark:stroke-dark-primary" d="M6.37305 11.0703V16.937" stroke="#9100D9" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
          <path class="stroke-primary dark:stroke-dark-primary" d="M21.6289 11.0703V16.937" stroke="#9100D9" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
          ` },
