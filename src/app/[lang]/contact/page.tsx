              ...
              <div>
                ...
                <main className="overflow-x-hidden w-full bg-white dark:bg-[#1A1A18] rounded-xl dark:text-white py-5 px-2 md:px-4 lg:p-7 mt-7">
                  <div className="flex-col flex gap-7 lg:flex-row w-full">
                    ...
                    <div className="flex flex-col gap-7 w-full lg:w-1/2 justify-center lg:justify-start w-full mt-5">
                      <div className="flex flex-col w-full items-center  gap-5  px-5 dark:text-white text-start ">
                        <p>آدرس :  قزوین - بخش مرکزی - ملاصدرا - خیابان میرداماد - نبش بن بست پویا - پلاک ۴۵</p>
                        <p>تلفن پشتیبانی: <a href="tel:02833647125"> 02833647125</a></p>
                        <p>ساعات پاسخگویی شنبه - چهارشنبه 9 تا 13</p>
                      </div>
