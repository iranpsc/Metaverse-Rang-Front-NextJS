// app/[lang]/version/loading.tsx
// این فایل فقط موقع ورود واقعی به روت (لود اول یا رفرش) توسط Next.js نمایش داده میشه.
// جابه‌جایی بین ورژن‌ها داخل صفحه با state کلاینتی مدیریت میشه و این اسکلت رو دوباره صدا نمیزنه.
